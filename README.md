...
질문: KOSPI란 무엇이지? 
응답: 
  KOSPI(Korea Composite Stock Price Index)의 정의와 특징:
  - 정의: 한국거래소(KRX)에 상장된 모든 보통주의 시가총액 기준 한국 대표
  주가지수
  - 기준시점: 1980년 1월 4일 (기준지수 100)
  - 계산방식: 시가총액 가중방식 → 삼성전자, SK하이닉스 등 대형주 영향 큼
  - 시장특성: 외국인 비중 높아 글로벌 위험 선호도에 민감
